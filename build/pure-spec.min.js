(function(){function i(){var a={a:{name:"Ninja",age:300}};a.b=function(a){function c(){}c.prototype=a;return new c}(a.a);a.b.stars=800;a.b.health=1E3;return a}var f=String,g=Number,h=Boolean,j=Array;module("Adherence Tests");test("wild card adheresTo test",function(){ok(PURE.adheresTo({age:23},{age:"*"}),'Expect object to adhereTo {age: "*"}.');equal(PURE.adheresTo({age:void 0},{age:"*"}),!1,'Dont expect object to adhereTo {age: "*"}.');ok(PURE.adheresTo({age:null},{age:"*"}),'Expect object to adhereTo {age: "*"}.');
ok(PURE.adheresTo({age:{}},{age:"*"}),'Expect object to adhereTo {age: "*"}.');equal(PURE.adheresTo({},{age:"*"}),!1,'Dont expect object to adhereTo {age: "*"}.')});test("adherence test",function(){ok(PURE.adheresTo({},Object.prototype),"Expect object to adhereTo Object.prototype.");ok(PURE.adheresTo({name:"Darren",age:29},{name:"string",age:"number"}),'Expect object to adhereTo {name: "string", age: "number"}.')});module("Consructor Tests");test("empty constructor test",function(){var a=PURE.constructor.create(),
b=new a,c=a();strictEqual(typeof a,"function","Expect Ctr to be a function.");ok(b instanceof a,"Expect o to be an instance of Ctr.");ok(c instanceof a,"Expect j to be an instance of Ctr.");"function"===typeof Object.prototype.isPrototypeOf&&(ok(a.prototype.isPrototypeOf(b),"Expect Ctr.prototype is a prototype of o."),ok(a.prototype.isPrototypeOf(c),"Expect Ctr.prototype is a prototype of j."));"function"===typeof Object.getPrototypeOf&&(strictEqual(Object.getPrototypeOf(b),a.prototype,"Expect prototype of o is equal to Ctr.prototype."),
...
ok(PURE.adheresTo(d,c.prototype),"Expect ninja to adhere to Person.prototype.")});module("Mixin Tests");test("ownProperty test",function(){var a=i(),b=PURE.mixin({},a.b);strictEqual(b.stars,a.b.stars,"Expect o.stars to equal b.stars.");strictEqual(b.health,a.b.health,"Expect o.health to equal b.health.");notStrictEqual(b.name,a.a.name,"Don't Expect o.name to equal a.name.");notStrictEqual(b.age,a.a.age,"Don't expect o.age to be equal to a.age.")});test("overwrite property test",function(){var a=i(),
...
2,3]),"Expect array literal to be an array.");ok(PURE.isArray(new j(3)),"Expect new Array() object to be an array.");ok(PURE.isArray({length:0,push:function(){}}),"Expect array-like object to be an array.");ok(PURE.isArray(a),"Expect extended array object to be an array.");equal(PURE.isArray(33.33),!1,"Don't expect number literal to be an array.");equal(PURE.isArray("some string literal"),!1,"Don't expect string literal to be an array.");equal(PURE.isArray(new f("some string literal")),!1,"Don't expect string object to be an array.")});
test("isObject test",function(){var a=function(){};a.prototype=Array.prototype;a=new a;ok(PURE.isObject({key:"value"}),"Expect object literal to be an object.");ok(PURE.isObject(new g(4)),"Expect number object to be an object.");ok(PURE.isObject(new f("4")),"Expect string object to be an object.");ok(PURE.isObject(new h(!1)),"Expect boolean object to be an object.");ok(PURE.isObject([1,2,3]),"Expect array literal to be an object.");ok(PURE.isObject(new j(3)),"Expect new Array() object to be an object.");
